...
export function registerReadTools(server: McpServer, projectRoot: string): void {
  server.tool(
    "query_decisions",
    "Retrieve relevant decision records for a file path, query, or scope. Returns a decision pack with active precedents, abandoned approaches, recently superseded decisions, and pending inbox items.",
    {
